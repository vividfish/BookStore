...
<body style="background: rgb(78, 78, 78); color: #fff;">
	...
	<div style="line-height: 10px;">
		...
		<span style="padding-left: 50px;"> <a
				href="<c:url value='/admin/AdminFindAllCategory'/>">分类管理</a> <a
				href="<c:url value='/adminjsps/admin/book/main.jsp'/>">图书管理</a> <a
				href="<c:url value='/admin/AdminFindAllOrder'/>">订单管理</a>
		</span>
	</div>
</body>
</html>
