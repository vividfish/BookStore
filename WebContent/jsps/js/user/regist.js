...
function validateLoginname() {
	 ...
	 */
	$.ajax({
		url : "/BookStore/ajaxValidateLoginname",// 要请求的servlet
		data : {
			loginname : value
		},
		type : "POST",
...
function validateEmail() {
	 ...
	 */
	$.ajax({
		url : "/BookStore/ajaxValidateEmail",// 要请求的servlet
		data : {
			email : value
		},// 给服务器的参数
		type : "POST",
...
function validateVerifyCode() {
	 ...
	 */
	$.ajax({
		url : "/BookStore/ajaxValidateVerifyCode",// 要请求的servlet
		data : {
			verifyCode : value
		},// 给服务器的参数
		type : "POST",
...
function _hyz() {
	...
	$("#imgVerifyCode").attr("src",
			"/BookStore/VerifyCodeServlet?a=" + new Date().getTime());
}
