...
<script type="text/javascript">
		...
		$(".jian").click(function() {
			...
			if (quantity == 1) {
				if (confirm("您是否真要删除该条目？")) {
					location = "/BookStore/batchDelete?cartItemIds=" + id;
				}
			} else {
	...
	function batchDelete() {
		...
		location = "/BookStore/batchDelete?cartItemIds=" + cartItemIdArray;
	}
...
<body>
	...
	<c:choose>
		...
		<c:otherwise>
			<table width="95%" align="center" cellpadding="0" cellspacing="0">
				...
				<c:forEach items="${cartItemList }" var="cartItem">
					<tr align="center">
						...
						<td>
							<a
								href="<c:url value='/batchDelete?cartItemIds=${cartItem.cartItemId }'/>">删除</a>
						</td>
					</tr>
				</c:forEach>
				<tr>
			...
			<form id="jieSuanForm" action="<c:url value='/loadCartItems'/>"
				method="post">
